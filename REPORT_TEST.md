...
**① 7 月交付口径终值（确认 run=sweep@400 逐位预演的正式落档）**：tp 1036/fp 77/fn 21/tn 1495，P 0.9308/R 0.9801/**F1 0.9548**；vs thr30 链 **fp 244→77（-68.4%）、全关日 128→18（-85.9%）、F1 +0.0597**；vs chain@10 全关日 140→18（-87.1%）——**⑯ 治理目标（全关天虚报）在交付口径达成**。
